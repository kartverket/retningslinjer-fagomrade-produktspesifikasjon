...
image::images/standardnivå_objektkataloger["Figur som viser forhold mellom modeller i ulike standardnivå og deres objektkataloger"]
...
image::images/innsnevring["Figur som viser innsnevring av standarder i en produktspesifikasjon"]
